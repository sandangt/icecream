package sanlab.icecream.lookup.config;
...
import sanlab.icecream.sharedlib.proto.AddressDTO;
...
public class KafkaConsumerConfig {
    ...
    private Map<String, Object> generateProtobufObjConfig() {
        ...
        properties.put(ConsumerConfig.GROUP_ID_CONFIG, KafkaGroup.LOOKUP);
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, MediaDTO> mediaListenerContainerFactory() {
        ConcurrentKafkaListenerContainerFactory<String, MediaDTO> factory =
            new ConcurrentKafkaListenerContainerFactory<>();
        Map<String, Object> properties = generateProtobufObjConfig();
        properties.put(KafkaProtobufDeserializerConfig.SPECIFIC_PROTOBUF_VALUE_TYPE, MediaDTO.class.getName());
